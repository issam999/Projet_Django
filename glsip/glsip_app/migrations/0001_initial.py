# Generated by Django 4.2.7 on 2023-11-20 19:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('availble', 'availble'), ('rental', 'retal'), ('sold', 'sold')], max_length=250, null=True)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='glsip_app.category')),
            ],
        ),
    ]
